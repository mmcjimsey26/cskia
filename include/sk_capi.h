...
typedef void (*gr_glfuncptr_t)();

// include/gpu/gl/GrGLAssembleInterface.h
typedef gr_glfuncptr_t (*gr_glgetproc_t)(void *ctx, const char name[]);
...
// include/gpu/gl/GrGLAssembleInterface.h
SK_C_API const gr_glinterface_t *
...
SK_C_API sk_image_filter_t *sk_imagefilter_new_dilate(int radiusX, int radiusY,
                                                      sk_image_filter_t *input,
                                                      const sk_rect_t *rect);
...
SK_C_API sk_image_filter_t *sk_imagefilter_new_distant_lit_specular(
    const sk_point3_t *direction, sk_color_t lightColor, float surfaceScale,
    float ks, float shininess, sk_image_filter_t *input, const sk_rect_t *rect);
SK_C_API sk_image_filter_t *
...
SK_C_API sk_image_filter_t *sk_imagefilter_new_erode(int radiusX, int radiusY,
                                                     ...
                                                     const sk_rect_t *rect);
SK_C_API sk_image_filter_t *
sk_imagefilter_new_magnifier(const sk_rect_t *src, float inset,
                             sk_image_filter_t *input, const sk_rect_t *rect);
...
sk_imagefilter_new_merge(sk_image_filter_t *filters[], int count,
                         const sk_rect_t *rect);
SK_C_API sk_image_filter_t *sk_imagefilter_new_offset(float dx, float dy,
                                                      sk_image_filter_t *input,
                                                      const sk_rect_t *rect);
...
SK_C_API sk_surface_props_t *sk_surfaceprops_default(void);
